...
to setup
  clear-all
  setup-strategies
  ask patches[set food random(food-uper-limit)
    set water random(1000)
    if (water > 500) [set pcolor green]
    if (food > (food-uper-limit / 2)) [set pcolor green]
    if (food <= 500 and water <= 500) [set pcolor red]
    ]
  ask n-of 50 patches[set danger random(100) set pcolor brown]
  reset-ticks
end
...
"pen-1" 1.0 0 -13345367 true "" "plot count truth-strategy"
"pen-2" 1.0 0 -2674135 true "" "plot count simple-strategy"
